            ...
            if add_item_form.is_valid():
                ...
                if not item_found:
                    current_items.append({
                        ...
                        'line_subtotal': str(product_detail_batch._get_individual_items_from_decimal(quantity_to_add, product_detail_batch.items_per_master_unit) * selling_price_item)
                    })
